 ...
 */
class FileCookieJar extends \_PhpScoper5e394cb3b4e38\GuzzleHttp\Cookie\CookieJar
{
    /** @var string filename */
    private $filename;
    ...
    public function save($filename)
    {
        ...
        $jsonStr = \_PhpScoper5e394cb3b4e38\GuzzleHttp\json_encode($json);
    ...
    public function load($filename)
    {
        ...
        $data = \_PhpScoper5e394cb3b4e38\GuzzleHttp\json_decode($json, \true);
        if (\is_array($data)) {
